...
import sys
sys.path.append('../preprocess_utils.py')
...
from preprocess_utils import make_train_data_structure, divide_train_val, take_anno_params, resize_img, \
    resize_anno_params
...
def save_train_val_files(orig_img_train_paths: str, orig_img_val_paths: str, orig_anno_train_paths: str,
